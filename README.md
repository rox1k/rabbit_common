...
It's meant to be included in your rebar projects in your rebar.config file:
		...
		{deps, [
			{rabbit_common, ".*", {git, "git://github.com/synlay/rabbit_common.git", "rabbitmq-2.8.7"}}
		]}.
...
to the version tag:
		...
		{deps, [
			{rabbit_common, ".*", {git, "git://github.com/synlay/rabbit_common.git", "rabbitmq-2.8.7-community"}}
		]}.
